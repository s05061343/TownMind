...
### 4.3 Screen-observed, user-controlled automation

AgePilot 的狀態來源只觀察玩家本來能在畫面上看到的資訊。依專案負責人 2026-08-09 的範圍變更，可選擇透過 Windows `SendInput` 執行使用者自訂的生產快捷鍵序列。
